...
<body>
    <div class="weui-cell">
        <div class="weui-cell__hd"><label id="uLabel" class="weui-label">${hint.label}</label></div>
        <div class="weui-cell__bd">
            <input class="weui-input" id="uid" type="number" placeholder="${hint.placeholder}"/>
        </div>
    </div>
    ...
    <asset:javascript src="binduser.js"/>
</body>
</html>
